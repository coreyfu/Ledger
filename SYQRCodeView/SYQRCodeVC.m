...
@interface SYQRCodeVC () <AVCaptureMetadataOutputObjectsDelegate>
...
- (void)setOverlayPickerView
{
    ...
    UIView* upView = [[UIView alloc] initWithFrame:CGRectMake(0, 0, kDeviceWidth, kLineMinY)];
    upView.alpha = 0.3;
